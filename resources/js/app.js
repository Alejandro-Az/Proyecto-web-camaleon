...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function showAlert(type, message) {
        ...
        const baseClasses =
            'rounded-2xl px-4 py-3 text-sm border mb-2';
    ...
    async function handleSuggestionSubmit(event) {
        ...
        try {
            ...
            // Si no hay lista (por ejemplo, estaba vacía), asegurar UL
            if (emptyMessage) {
                emptyMessage.remove();
            }
            ...
            if (songsList && data.song) {
                ...
                // Construimos el HTML de la canción nueva (simplificado, pero consistente)
                li.innerHTML = `
